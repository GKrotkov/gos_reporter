# Statbotics API reader

library(jsonlite)
library(httr)
library(sys)

BASE <- "https://api.statbotics.io/v2"
...
read_teams <- function(metric = "team", country = NA, district = NA, state = NA, 
                       active = NA, ascending = TRUE, 
                       limit = 100, offset = 0){
...
read_team_year <- function(n, year){
...
#' @param offset (int) Length of the offset of the beginning of the pull from 
#' the sorted list.
read_team_years <- function(team = NA, year = NA, country = NA, district = NA, 
                            state = NA, metric = NA, ascending = NA, limit = NA,
                            offset = NA){
...
read_team_event <- function(n, key){
...
#' @param offset (int) Length of the offset of the beginning of the pull from 
#' the sorted list.
read_team_events <- function(team = NA, year = NA, event = NA, country = NA,
                             district = NA, state = NA, type = NA, week = NA, 
                             metric = NA, ascending = NA, 
                             limit = NA, offset = NA){
...
read_team_match <- function(team, key){
...
#' @param offset (int) Length of the offset of the beginning of the pull from 
#' the sorted list.
read_team_matches <- function(team = NA, year = NA, event = NA, week = NA, 
                              match = NA, elims = NA, metric = NA, 
...
read_event <- function(key){
    req <- paste("event", key, sep = "/")
    return(get_content(req))
}

read_events <- function(year = NA, country = NA, district = NA, state = NA, 
                        type = NA, week = NA, metric = NA, ascending = NA, 
                        limit = NA, offset = NA){
...
#' @param offset (int) Length of the offset of the beginning of the pull from 
#' the sorted list.
read_matches <- function(team = NA, year = NA, event = NA, week = NA, 
                         elims = NA, metric = NA, ascending = NA, 
                         limit = NA, offset = NA){
