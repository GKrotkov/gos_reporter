...
for (x in blue_df[,1])
{
  ...
  #alliance? unsure)
  print(paste("TEAM NUMBER: ", x))
  print(paste("Drive Type: ", pitdata[pitdata$Team.Number == x, "DriveType"]))
  print(paste("Height: ",pitdata[pitdata$Team.Number == x, "Height"], 
              "Weight: ",pitdata[pitdata$Team.Number == x, "Weight"]))
  print(paste("Amp accuracy: ", scouted[scouted$team_number == x, "tele_amp_accuracy"], 
              "Speaker accuracy: ", scouted[scouted$team_number == x, "tele_spk_accuracy"]))
  print(paste("Can climb?: ", tba_data[tba_data$id == x, "endgame_onstage_pct"]>0))
  print(paste("Can trap?: ", scouted[scouted$team_number == x, "trap_avg"]>0))
  print(paste("Expected point contribution: ",viz[viz$team_number == x, "scouted_score"]))
}
...
for (x in red_df[,1])
{
  ...
  print(paste("Can trap?: ", scouted[scouted$team_number == x, "trap_avg"]>0))
  print(paste("Expected point contribution: ",viz[viz$team_number == x, "scouted_score"]))
  print(paste("Comments: ", comments[comments$team_number == x & (comments$x != "undefined" & comments$x != "" & comments$x != "NA") , "x"]))
