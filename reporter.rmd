...
scouted <- read.delim("data/scouter_data.txt")
...
- Scoring statistics for each team 
- Endgame info 
- Comments

Graphs (2-Var): 
- Avg Amp Notes and Misses vs team (qual)
- Avg Speaker Notes and Misses vs team (qual)
...
```{r}
red_alliance <- c(3467, 131, 78)
blue_alliance <- c(166, 2423, 4909)
...
#PAST THIS POINT IS A STACKED BAR GRAPH DEFAULT CODE
#DO NOT CHANGE -- IS JUST COPY AND PASTED FROM THE TUTORIAL 
